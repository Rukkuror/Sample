class UntrustworthyOrdersController < ApplicationController
  ...
  def untrustworthy_orders
    @in = {
          ...
          {:id => "2", :order_type => "RDB", :company_name => "test company name two", :customer_phone => "123-456-2581", :customer_email => "test123@gmail.com", :host_site => "CA", :past_job_order_count => "1", :past_rdb_order_count => "12", :login_ips => ["121.241.197.51"], :past_approval => "Rejected", :order_status => "HLD", :payments => [], :created_at => "2014-07-18 09:08:00 +0530"},
          {:id => "3", :order_type => "Job", :company_name => "ABC Pvt Ltd", :customer_phone => "123-456-2522", :customer_email => "test12@gmail.com", :host_site => "CA", :past_job_order_count => "1", :past_rdb_order_count => "1", :login_ips => ["121.241.197.51"], :past_approval => "", :order_status => "HLD", :payments => [], :created_at => "2014-07-18 09:00:00 +0530"}
          ]}
